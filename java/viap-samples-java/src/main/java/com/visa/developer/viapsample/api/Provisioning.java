...
public class Provisioning {
	...
	public Provisioning() throws KeyManagementException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyStoreException, CertificateException, IOException {
		apiClient = new ApiClient();
		configReader = new ConfigReader();
	}
	
	
	public HttpResponse applePay (String payload) throws SignatureException, ClientProtocolException, IOException {
		String host = configReader.getProperty("HOST");
		String baseUri = "inapp/";
	...
	public HttpResponse googlePay(String payload) throws SignatureException, ClientProtocolException, IOException {
		String host = configReader.getProperty("HOST");
		String baseUri = "inapp/";
	...
	public HttpResponse samsungPay(String payload) throws SignatureException, ClientProtocolException, IOException {
		String host = configReader.getProperty("HOST");
		String baseUri = "inapp/";
		String resourcePath = "provisioning/cardData/samsungPay";
