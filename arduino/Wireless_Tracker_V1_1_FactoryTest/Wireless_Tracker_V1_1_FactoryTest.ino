/*
 * HelTec Automation(TM) Wireless_Tracker_V1.1_FactoryTest factory test code, witch includ
 * follow functions:
 * 
 * - Basic TFT function test;
 * 
...
void wifi_connect_init(void)
{
	...
	WiFi.begin("TELUS0290","H4JbPt8NL4Fb");//fill in "Your WiFi SSID","Your Password"
