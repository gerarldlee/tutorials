...
// Adafruit_SSD1306 display1(/*MOSI*/ 11, /*CLK*/ 13, /*DC*/ 9, /*RESET*/ 8, /*CS*/ 10);

// Adafruit_ILI9341 display(/*MOSI*/ _mosi, /*CLK*/ _clk, /*DC*/ _dc, /*RESET*/ _reset, /*CS*/ _cs);
Adafruit_ILI9341 display(_cs, _dc, _mosi, _clk, _reset, _miso);
...
//   u8g2.setForegroundColor(ILI9341_WHITE);      // apply Adafruit GFX color
...
//   u8g2.print("Umlaut ÄÖÜ");            // UTF-8 string with german umlaut chars

//   u8g2.setFont(u8g2_font_inb63_mn);  // select u8g2 font from here: https://github.com/olikraus/u8g2/wiki/fntlistall
//   u8g2.setFontMode(0);                 // use u8g2 none transparent mode
//   u8g2.setCursor(0,220);                // start writing at this position
//   u8g2.print(x);            // UTF-8 string with german umlaut chars
//   x++;
//   delay(1000);
// } 
